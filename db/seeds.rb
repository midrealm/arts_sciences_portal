...
category = Category.create(:name => 'Dance Performance', division: performance,
...
entry = Entry.create(entry_name: 'test entry', description: 'test entry description', user_id: admin.id, category_id: category.id, fair_id: fair.id)
