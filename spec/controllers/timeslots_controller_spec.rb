  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Timeslot" do
        expect {
          post :create, params: {timeslot: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {timeslot: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested timeslot" do
        timeslot = Timeslot.create! valid_attributes
        put :update, params: {id: timeslot.to_param, timeslot: new_attributes}, session: valid_session
        timeslot.reload
      ...
      it "redirects to the timeslot" do
        timeslot = Timeslot.create! valid_attributes
        put :update, params: {id: timeslot.to_param, timeslot: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        timeslot = Timeslot.create! valid_attributes
        put :update, params: {id: timeslot.to_param, timeslot: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
