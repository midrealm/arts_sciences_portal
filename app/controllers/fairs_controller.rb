class FairsController < ApplicationController
  ...
  private
    ...
    def fair_params
      params.require(:fair).permit(:date, :region_id, :name, :comment, :internet_access, :entries_allowed, :scheduling_visible, :scoresheets_allowed, :mail_in_scoresheets_allowed)
    end
